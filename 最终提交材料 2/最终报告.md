...
| Integration testing | Docker-backed PostgreSQL and backend service are started before API smoke verification | Integration job in E22 and `E09-api-verification-postman.png` |
| Load and stress testing | Automated load stage sends 500 requests at concurrency 25 | Successful load job and retained results in E22 |
