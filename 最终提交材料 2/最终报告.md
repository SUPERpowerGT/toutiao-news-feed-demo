...
CodeQL analysed Go and Java/Kotlin successfully in E23. The retained evidence does not show an actionable CodeQL alert and therefore this report does not invent a SAST remediation claim. The demonstrated remediation and rescan loops are the genuine Trivy dependency/image findings and ZAP dynamic findings shown above.
...
| SAST | CodeQL analyses Go and Java/Kotlin | E23 successful two-language CodeQL run |
