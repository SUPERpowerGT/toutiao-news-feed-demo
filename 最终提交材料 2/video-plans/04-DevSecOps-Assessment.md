...
| --- | --- |
| ![Semgrep historical client-IP finding](../assets/E33-semgrep-sast-remediation.png) | The right-hand panel in E33 shows the current backend rescan with 0 findings across 18 parsed Go targets. |
